def main():
    ...
    from Code.interface_package.interface import app_interface  
    ...
    mlp = MLP(num_inputs=X_train.shape[1], hidden_layers=[3, 3], num_outputs=2)  # 2 outputs for classes 0 (not survived) and 1 (survived)
    
    # Training the MLP model
    mlp.train(X_train, y_train, epochs=400, learning_rate=0.2)    
